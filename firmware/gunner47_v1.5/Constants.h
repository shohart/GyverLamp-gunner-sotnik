...
#define EFF_CLOCK               (65U)    // Часы
#define EFF_TEXT                (66U)    // Бегущая строка


#define MODE_AMOUNT           (67U)          // количество режимов
...
String("65. Часы,70,245,1,100,1;") +
String("66. Бегущая строка,1,252,1,100,1;") +
