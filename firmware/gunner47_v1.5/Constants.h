...
// ============= НАСТРОЙКИ =============
#define USE_OLD_APP_FROM_KOTEYKA                            // удалить эту строку, если вы используете более свежую версию приложения, чем та, что в архиве с прошивкой
...
#define EFF_FIRE_2012           (21U)    // Огонь 2012
#define EFF_FIRE_2018           (22U)    // Огонь 2018
#define EFF_FIRE                (23U)    // Огонь
#define EFF_FIRE_WHITTE         (24U)    // Белый огонь
#define EFF_FIRE_GREEN          (25U)    // Цветной огонь
...
#define EFF_SIMPLE_RAIN         (47U)    // Тучка в банке
#define EFF_STORMY_RAIN         (48U)    // Гроза в банке
#define EFF_COLOR_RAIN          (49U)    // Осадки
#define EFF_RAIN                (50U)    // Разноцветный дождь
#define EFF_SNOW                (51U)    // Снегопад
...
#define EFF_RAINBOW_VER         (57U)    // Радуга вертикальная
#define EFF_RAINBOW_HOR         (58U)    // Радуга горизонтальная
#define EFF_RAINBOW_DIAG        (59U)    // Радуга диагональная
#define EFF_CUBE                (60U)    // Блуждающий кубик
#define EFF_COLORS              (61U)    // Смена цвета
...
String("21. Огонь 2012,50,252,1,100,0;") +
String("22. Огонь 2018,50,252,1,100,0;") +
String("23. Огонь,50,252,1,100,1;") +
String("24. Белый огонь,50,252,1,100,1;") +
String("25. Цветной огонь,50,252,1,100,1;") +
String("26. Вихри пламени,100,252,1,100,1;") +
String("27. Разноцветные вихри,100,252,1,100,0;") +
String("28. Водопад,50,252,1,100,1;") +
String("29. Белый водопад,50,252,1,100,1;") +
String("30. Водопад 4 в 1,50,252,1,100,0;") +
String("31. Бассейн,100,252,1,100,1;") +
String("32. Медленный пульс,50,252,1,100,0;") +
String("33. Быстрый пульс,50,252,1,100,0;") +
String("34. Радужный пульс,50,252,1,100,0;") +
String("35. Белый пульс,50,252,1,100,0;") +
String("36. Комета,60,252,1,100,0;") +
String("37. Белая комета,60,252,1,100,0;") +
String("38. Одноцветная комета,60,252,1,100,1;") +
String("39. Пульсирующая комета,60,252,1,100,0;") +
String("40. Две кометы,60,252,1,100,0;") +
String("41. Три кометы,60,252,1,100,0;") +
String(+ "\n");
const String efList_3 = String("LIST3;") + // ======== ТРЕТЬЯ СТРОКА ========
String("42. Парящий огонь,60,252,1,100,0;") +
String("43. Верховой огонь,60,252,1,100,0;") +
String("44. Радужный змей,60,252,100,100,0;") +
String("45. Конфетти,60,252,1,100,0;") +
String("46. Волны,220,252,1,100,0;") +
String("47. Тучка в банке,60,252,1,100,0;") +
String("48. Гроза в банке,60,252,1,100,0;") +
String("49. Осадки,60,252,0,255,1;") +
String("50. Разноцветный дождь,60,252,1,100,1;") +
String("51. Снегопад,50,252,1,100,0;") +
String("52. Метель,50,252,1,100,0;") +
String("53. Звездопад,50,252,1,100,0;") +
String("54. Светлячки,50,252,1,100,0;") +
String("55. Светлячки со шлейфом,50,252,1,100,0;") +
String("56. Пейнтбол,215,252,1,100,0;") +
String("57. Радуга вертикальная,50,252,1,100,0;") +
String("58. Радуга горизонтальная,50,252,1,100,0;") +
String("59. Радуга диагональная,50,252,1,100,0;") +
String("60. Блуждающий кубик,70,252,1,100,0;") +
String("61. Смена цвета,1,252,1,100,0;") +
String("62. Бегущая строка,1,252,1,100,1;") +
