...
//#define DONT_TURN_ON_AFTER_SHUTDOWN                       // раскомментируйте эту строку, если нужно, чтобы лампа не возобновляла демонстрацию эффекта после обесточивания
...
#define NTP_INTERVAL          (59UL * 60UL * 1000UL)        // интервал синхронизации времени (59 минут)
...
#define EFF_BBALLS_WHITE        (13U)    // Белые мячики
#define EFF_BBALLS_TRACES       (14U)    // Мячики со шлейфом
...
#define EFF_SIMPLE_RAIN         (49U)    // Тучка в банке
#define EFF_STORMY_RAIN         (50U)    // Гроза в банке
#define EFF_COLOR_RAIN          (51U)    // Осадки
#define EFF_RAIN                (52U)    // Разноцветный дождь
#define EFF_SNOW                (53U)    // Снегопад
#define EFF_SNOWSTORM           (54U)    // Метель
#define EFF_STARFALL            (55U)    // Звездопад
#define EFF_LIGHTERS            (56U)    // Светлячки
#define EFF_LIGHTER_TRACES      (57U)    // Светлячки со шлейфом
#define EFF_PAINTBALL           (58U)    // Пейнтбол
#define EFF_RAINBOW_VER         (59U)    // Радуга вертикальная
#define EFF_RAINBOW_HOR         (60U)    // Радуга горизонтальная
#define EFF_RAINBOW_DIAG        (61U)    // Радуга диагональная
#define EFF_CUBE                (62U)    // Блуждающий кубик
#define EFF_TEXT                (63U)    // Бегущая строка


#define MODE_AMOUNT           (64U)          // количество режимов
...
String("13. Белые мячики,1,255,1,100,0;") +
String("14. Мячики со шлейфом,1,255,1,100,0;") +
...
String("49. Тучка в банке,60,252,1,100,0;") +
String("50. Гроза в банке,60,252,1,100,0;") +
String("51. Осадки,60,252,0,255,1;") +
String("52. Разноцветный дождь,60,252,1,100,1;") +
String("53. Снегопад,50,252,1,100,0;") +
String("54. Метель,50,252,1,100,0;") +
String("55. Звездопад,50,252,1,100,0;") +
String("56. Светлячки,50,252,1,100,0;") +
String("57. Светлячки со шлейфом,50,252,1,100,0;") +
String("58. Пейнтбол,215,252,1,100,0;") +
String("59. Радуга вертикальная,50,252,1,100,0;") +
String("60. Радуга горизонтальная,50,252,1,100,0;") +
String("61. Радуга диагональная,50,252,1,100,0;") +
String("62. Блуждающий кубик,70,252,1,100,0;") +
String("63. Бегущая строка,1,252,1,100,1;") +
