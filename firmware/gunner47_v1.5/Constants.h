...
#define EFF_CLOUDS              ( 2U)    // Облака
#define EFF_LAVA                ( 3U)    // Лава
#define EFF_PLASMA              ( 4U)    // Плазма
#define EFF_RAINBOW             ( 5U)    // Радуга 3D
#define EFF_RAINBOW_STRIPE      ( 6U)    // Павлин
#define EFF_ZEBRA               ( 7U)    // Зебра
#define EFF_FOREST              ( 8U)    // Лес
#define EFF_OCEAN               ( 9U)    // Океан
#define EFF_BBALLS              (10U)    // Мячики
#define EFF_BBALLS_WHITE        (11U)    // Белые мячики
#define EFF_BBALLS_TRACES       (12U)    // Мячики со шлейфом
#define EFF_SPIRO               (13U)    // Спирали
#define EFF_SINUSOID3           (14U)    // Синусоид
#define EFF_METABALLS           (15U)    // Метаболз


#define EFF_FIRE                (16U)    // Огонь
#define EFF_FIRE_WHITTE         (17U)    // Белый огонь
#define EFF_FIRE_BLUE           (18U)    // Голубой огонь
#define EFF_FIRE_GREEN          (19U)    // Зелёный огонь
#define EFF_MATRIX              (20U)    // Матрица
#define EFF_WATERFALL           (21U)    // Водопад
#define EFF_WATERFALL_WHITE     (22U)    // Белый водопад
#define EFF_WATERFALL_4IN1      (23U)    // Водопад 4 в 1
#define EFF_PULSE_SLOW          (24U)    // Медленный пульс
#define EFF_PULSE_FAST          (25U)    // Быстрый пульс
#define EFF_PULSE_RAINBOW       (26U)    // Радужный пульс
#define EFF_PULSE_WHITE         (27U)    // Белый пульс
#define EFF_COMET               (28U)    // Комета
#define EFF_COMET_WHITE         (29U)    // Белая комета
#define EFF_COMET_COLOR         (30U)    // Одноцветная комета
#define EFF_COMET_PULSING       (31U)    // Пульсирующая комета
#define EFF_COMET_TWO           (32U)    // Две кометы
#define EFF_COMET_THREE         (33U)    // Три кометы


#define EFF_FIREFLY             (34U)    // Парящий огонь
#define EFF_FIREFLY_TOP         (35U)    // Верховой огонь
#define EFF_SNAKE               (36U)    // Радужный змей
#define EFF_RAIN                (37U)    // Цветной дождь
#define EFF_SPARKLES            (38U)    // Конфетти
#define EFF_RAINBOW_VER         (39U)    // Радуга вертикальная
#define EFF_RAINBOW_HOR         (40U)    // Радуга горизонтальная
#define EFF_RAINBOW_DIAG        (41U)    // Радуга диагональная
#define EFF_POOL                (42U)    // Бассейн
#define EFF_SNOW                (43U)    // Снегопад
#define EFF_SNOWSTORM           (44U)    // Метель
#define EFF_STARFALL            (45U)    // Звездопад
#define EFF_LIGHTERS            (46U)    // Светлячки
#define EFF_LIGHTER_TRACES      (47U)    // Светлячки со шлейфом
#define EFF_PAINTBALL           (48U)    // Пейнтбол
#define EFF_CUBE                (49U)    // Блуждающий кубик
#define EFF_COLORS              (50U)    // Смена цвета
#define EFF_COLOR               (51U)    // Цвет
#define EFF_TEXT                (52U)    // Бегущая строка

#define MODE_AMOUNT           (53U)          // количество режимов
...
String("2. Облака,1,15,1,50,0;") +
String("3. Лава,5,60,1,100,0;") +
String("4. Плазма,1,30,1,100,0;") +
String("5. Радуга 3D,1,70,1,100,0;") +
String("6. Павлин,1,15,1,30,0;") +
String("7. Зебра,1,30,7,40,0;") +
String("8. Лес,2,30,70,100,0;") +
String("9. Океан,2,15,4,30,0;") +
String("10. Мячики,1,255,1,100,0;") +
String("11. Белые мячики,1,255,1,100,0;") +
String("12. Мячики со шлейфом,1,255,1,100,0;") +
String("13. Спирали,1,255,1,100,0;") +
String("14. Синусоид,1,255,1,100,0;") +
String("15. Метаболз,1,255,1,100,0;") +
String(+ "\n");
const String efList_2 = String("LIST2;") + // ======== ВТОРАЯ СТРОКА ========
String("16. Огонь,50,255,1,100,1;") +
String("17. Белый огонь,50,255,1,100,1;") +
String("18. Голубой огонь,50,255,1,100,1;") +
String("19. Зелёный огонь,50,255,1,100,1;") +
String("20. Матрица,100,240,1,100,0;") +
String("21. Водопад,50,255,1,100,1;") +
String("22. Белый водопад,50,255,1,100,1;") +
String("23. Водопад 4 в 1,50,255,1,100,0;") +
String("24. Медленный пульс,50,255,1,100,0;") +
String("25. Быстрый пульс,50,255,1,100,0;") +
String("26. Радужный пульс,50,255,1,100,0;") +
String("27. Белый пульс,50,255,1,100,0;") +
String("28. Комета,60,255,1,100,0;") +
String("29. Белая комета,60,255,1,100,0;") +
String("30. Одноцветная комета,60,255,1,100,1;") +
String("31. Пульсирующая комета,60,255,1,100,0;") +
String("32. Две кометы,60,255,1,100,0;") +
String("33. Три кометы,60,255,1,100,0;") +
String(+ "\n");
const String efList_3 = String("LIST3;") + // ======== ТРЕТЬЯ СТРОКА ========
String("34. Парящий огонь,60,255,1,100,0;") +
String("35. Верховой огонь,60,255,1,100,0;") +
String("36. Радужный змей,60,255,1,100,0;") +
String("37. Цветной дождь,60,255,1,100,1;") +
String("38. Конфетти,60,255,1,100,0;") +
String("39. Радуга вертикальная,50,255,1,100,0;") +
String("40. Радуга горизонтальная,50,255,1,100,0;") +
String("41. Радуга диагональная,50,255,1,100,0;") +
String("42. Бассейн,100,255,1,100,1;") +
String("43. Снегопад,50,255,1,100,0;") +
String("44. Метель,50,255,1,100,0;") +
String("45. Звездопад,50,255,1,100,0;") +
String("46. Светлячки,50,240,1,100,0;") +
String("47. Светлячки со шлейфом,50,240,1,100,0;") +
String("48. Пейнтбол,215,255,1,100,0;") +
String("49. Блуждающий кубик,70,235,1,100,0;") +
String("50. Смена цвета,1,255,1,100,0;") +
String("51. Цвет,1,255,1,100,1;") +
String("52. Бегущая строка,1,255,1,100,1;") +
...
#define MAX_UDP_BUFFER_SIZE   (129U)                        // максимальный размер буффера UDP сервера (если не влезает, можно обойти см. "LIST")
