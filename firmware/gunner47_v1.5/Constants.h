...
#define EFF_MATRIX              (24U)    // Матрица
#define EFF_WATERFALL           (25U)    // Водопад
#define EFF_WATERFALL_WHITE     (26U)    // Белый водопад
#define EFF_WATERFALL_4IN1      (27U)    // Водопад 4 в 1
#define EFF_POOL                (28U)    // Бассейн
#define EFF_PULSE_SLOW          (29U)    // Медленный пульс
#define EFF_PULSE_FAST          (30U)    // Быстрый пульс
#define EFF_PULSE_RAINBOW       (31U)    // Радужный пульс
#define EFF_PULSE_WHITE         (32U)    // Белый пульс
#define EFF_COMET               (33U)    // Комета
#define EFF_COMET_WHITE         (34U)    // Белая комета
#define EFF_COMET_COLOR         (35U)    // Одноцветная комета
#define EFF_COMET_PULSING       (36U)    // Пульсирующая комета
#define EFF_COMET_TWO           (37U)    // Две кометы
#define EFF_COMET_THREE         (38U)    // Три кометы


#define EFF_FIREFLY             (39U)    // Парящий огонь
#define EFF_FIREFLY_TOP         (40U)    // Верховой огонь
#define EFF_SNAKE               (41U)    // Радужный змей
#define EFF_SPARKLES            (42U)    // Конфетти
#define EFF_RAINBOW_VER         (43U)    // Радуга вертикальная
#define EFF_RAINBOW_HOR         (44U)    // Радуга горизонтальная
#define EFF_RAINBOW_DIAG        (45U)    // Радуга диагональная
#define EFF_WAVES               (46U)    // Волны
#define EFF_SNOW                (47U)    // Снегопад
#define EFF_RAIN                (48U)    // Цветной дождь
#define EFF_SNOWSTORM           (49U)    // Метель
#define EFF_STARFALL            (50U)    // Звездопад
#define EFF_LIGHTERS            (51U)    // Светлячки
#define EFF_LIGHTER_TRACES      (52U)    // Светлячки со шлейфом
#define EFF_PAINTBALL           (53U)    // Пейнтбол
#define EFF_CUBE                (54U)    // Блуждающий кубик
#define EFF_COLORS              (55U)    // Смена цвета
#define EFF_TEXT                (56U)    // Бегущая строка


#define MODE_AMOUNT           (57U)          // количество режимов
...
String("24. Матрица,100,240,1,100,0;") +
String("25. Водопад,50,255,1,100,1;") +
String("26. Белый водопад,50,255,1,100,1;") +
String("27. Водопад 4 в 1,50,255,1,100,0;") +
String("28. Бассейн,100,255,1,100,1;") +
String("29. Медленный пульс,50,255,1,100,0;") +
String("30. Быстрый пульс,50,255,1,100,0;") +
String("31. Радужный пульс,50,255,1,100,0;") +
String("32. Белый пульс,50,255,1,100,0;") +
String("33. Комета,60,255,1,100,0;") +
String("34. Белая комета,60,255,1,100,0;") +
String("35. Одноцветная комета,60,255,1,100,1;") +
String("36. Пульсирующая комета,60,255,1,100,0;") +
String("37. Две кометы,60,255,1,100,0;") +
String("38. Три кометы,60,255,1,100,0;") +
String(+ "\n");
const String efList_3 = String("LIST3;") + // ======== ТРЕТЬЯ СТРОКА ========
String("39. Парящий огонь,60,255,1,100,0;") +
String("40. Верховой огонь,60,255,1,100,0;") +
String("41. Радужный змей,60,255,1,100,0;") +
String("42. Конфетти,60,255,1,100,0;") +
String("43. Радуга вертикальная,50,255,1,100,0;") +
String("44. Радуга горизонтальная,50,255,1,100,0;") +
String("45. Радуга диагональная,50,255,1,100,0;") +
String("46. Волны,220,255,1,100,0;") +
String("47. Снегопад,50,255,1,100,0;") +
String("48. Цветной дождь,60,255,1,100,1;") +
String("49. Метель,50,255,1,100,0;") +
String("50. Звездопад,50,255,1,100,0;") +
String("51. Светлячки,50,240,1,100,0;") +
String("52. Светлячки со шлейфом,50,240,1,100,0;") +
String("53. Пейнтбол,215,255,1,100,0;") +
String("54. Блуждающий кубик,70,235,1,100,0;") +
String("55. Смена цвета,1,255,1,100,0;") +
String("56. Бегущая строка,1,255,1,100,1;") +
